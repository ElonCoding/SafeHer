...
class _ProfilePictureTileState extends State<_ProfilePictureTile> {
  ...
  Future<void> _pickAndUpload() async {
    ...
    try {
      ...
      if (result != null && result.files.single.path != null) {
        ...
        if (user != null) {
          final ref = FirebaseStorage.instanceFor(bucket: 'gs://safeher-d8237.firebasestorage.app').ref().child('profile_pics/${user.uid}.jpg');
  ...
  Future<String?> _getProfilePicUrl(User? user) async {
    ...
    try {
      final ref = FirebaseStorage.instanceFor(bucket: 'gs://safeher-d8237.firebasestorage.app/profile_pics').ref().child('profile_pics/${user.uid}.jpg');
