...
import 'package:safeher/views/map_view.dart';
import 'package:safeher/views/menu_view.dart';
import 'package:safeher/views/settings_view.dart';
import 'package:safeher/widgets/panic_button_widget.dart';
import 'package:safeher/views/safe_chat_view.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:safeher/services/sos_navigation_service.dart';
          ...
          title: const Text.rich(
            TextSpan(
              children: [
                ...
                TextSpan(text: 'Her', style: TextStyle(color: Color(0xFF232946), fontWeight: FontWeight.bold)),
              ],
            ),
