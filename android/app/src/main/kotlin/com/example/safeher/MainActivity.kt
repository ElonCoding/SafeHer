...
import com.example.safeher.FakeCallUtils

class MainActivity : FlutterActivity() {
    private val CHANNEL = "com.example.safeher/fakecall"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // Add support for com.example.safeher/prefs channel for saveFakeCallPrefs
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.example.safeher/prefs").setMethodCallHandler { call, result ->
            when (call.method) {
                "saveFakeCallPrefs" -> {
                    val prefs = getSharedPreferences("fake_call_prefs", Context.MODE_PRIVATE)
                    prefs.edit()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val isShakeTrigger = shakeIntent?.action == "com.example.safeher.TRIGGER_FAKE_CALL"
    ...
    private fun registerPhoneAccountAndOpenSettings() {
        ...
        val phoneAccountHandle = PhoneAccountHandle(componentName, "safeherFakeCall")
        val phoneAccount = PhoneAccount.builder(phoneAccountHandle, "safeher Fake Call")
