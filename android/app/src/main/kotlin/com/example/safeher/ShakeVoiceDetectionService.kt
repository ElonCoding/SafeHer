...
class ShakeDetectionService : Service(), SensorEventListener {
    ...
    override fun onCreate() {
        ...
        val filter = android.content.IntentFilter().apply {
            addAction("com.example.safeher.FAKE_CALL_ACCEPTED")
            addAction("com.example.safeher.FAKE_CALL_REJECTED")
        }
    ...
    private val fakeCallActionReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            if (intent?.action == "com.example.safeher.FAKE_CALL_ACCEPTED" || intent?.action == "com.example.safeher.FAKE_CALL_REJECTED") {
    ...
    private fun buildNotification(content: String): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("safeher Background Detection")
